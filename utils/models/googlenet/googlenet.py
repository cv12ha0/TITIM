...
def googlenet(img_shape, num_classes=1000):
    model = GoogleNet(img_shape, num_classes)
    model.config.update({'model': 'GoogleNet', })
    return model
...
class GoogleNet(nn.Module):
    def __init__(self, img_shape=(3, 224, 224), num_classes=1000):
        ...
        self.config = {'model': 'GoogleNet', 'img_shape': self.img_shape, 'num_classes': self.num_classes, }
